...
(function(window, document, $) {
    ...
    filterTextClear: "Очистить фильтр",
    filterPlaceHolder: "Фильтр",
    moveSelectedLabel: "Добавить выбранное",
    removeSelectedLabel: "Убрать выбранное",
    selectorMinimalHeight: 400, 
    infoTextFiltered: "<span class='label label- primary'>Отфильтровано</span> {0} из {1}",
    removeAllLabel: "Убрать всё",
    moveAllLabel: "Добавить всё",
    infoText: "Доступно элементов - {0}",
    nonSelectedListLabel: "Доступные значения",
    selectedListLabel: "Выбранные",
    infoTextEmpty: "Данные отсутствуют",
    moveOnSelect: false
  });
